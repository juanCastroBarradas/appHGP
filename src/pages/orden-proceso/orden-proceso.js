...
var OrdenProcesoPage = /** @class */ (function () {
    function OrdenProcesoPage(navCtrl, navParams, loadingCtrl, toastCtrl, api, modalCtrl) {
    ...
    OrdenProcesoPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad OrdenProcesoPage');
    };
    OrdenProcesoPage.prototype.cargaDatos = function () {
        var _this = this;
        var cestatus = 'PROCESO';
    ...
    OrdenProcesoPage.prototype.doRefresh = function (refresher) {
        this.cargaDatos();
        refresher.complete();
    };
    OrdenProcesoPage.prototype.itemTapped = function (event, item) {
    ...
    OrdenProcesoPage = __decorate([
        Component({
            selector: 'page-orden-proceso',
            templateUrl: 'orden-proceso.html',
        }),
        __metadata("design:paramtypes", [NavController, NavParams, LoadingController,
            ToastController, ApiProvider, ModalController])
    ], OrdenProcesoPage);
    return OrdenProcesoPage;
}());
export { OrdenProcesoPage };
//# sourceMappingURL=orden-proceso.js.map